Bach// 注: process.env.XX是Vercel的环境变量，配置方式见：https://docs.tangly1024.com/article/how-to-config-notion-next#c4768010ae7d44609b744e79e2f9959a
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || ' CS | Study | Gallery ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.solitudeblog.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2279915269@qq.com', // 邮箱地址 例如mail@tangly1024.com
